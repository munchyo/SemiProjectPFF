...
<body>
	...
	<header>로고, 네브바 영역</header>
	<main>
		<div style="width: 550px; height: 200px">
			<div class="titleArea">
				<h2>
					<span>{ loginUser.nickName }님의 MY PAGE</span>
				</h2>
				<hr>
			</div>
			...
			<div class="top-container">
				<ul>
					...
					<li class=" "><strong class="title">가용적립금</strong> <strong
						class="data use"> {loginUser.memberPoint}원 </strong> <a
						href="memberPoint.me"><img
							src="http://img.echosting.cafe24.com/skin/base_ko_KR/myshop/btn_result.gif"
							alt="조회" /></a></li>

					<li class="etc "><strong class="title">쿠폰</strong> <strong
						class="coupon">{loginUser.coupon}<span>개</span></strong> <a
						href="coupon.me"><img
							src="http://img.echosting.cafe24.com/skin/base_ko_KR/myshop/btn_result.gif"
							alt="조회" /></a></li>
				</ul>
		...
		<div class="main-container">
			<div class="list">
				<div style="">
					<svg xmlns="http://www.w3.org/2000/svg" width="100px"
						height="100px" fill="currentColor" class="bi bi-clipboard-check"
						viewBox="0 0 16 16">
  			...
  			<path
				...
				<h3>
					<a href="list.me"><strong>order</strong> 주문내역 조회</a>
				</h3>
			...
			<div class="modify">
  			...
  			<path
				...
				<h3>
					<a href="modify.me"><strong>profile</strong> 회원 정보</a>
				</h3>
			...
			<div class="cart">
  			...
  			<path
				...
				<h3>
					<a href="${contextPath}/Cart.po"><strong>review</strong> 장바구니 </a>
				</h3>
			...
			<div class="coupon">
  			...
  			<path
				...
				<h3>
					<a href="${contextPath}/memberList.me"><strong>coupon</strong>
						쿠폰</a>
				</h3>
			...
			<div class="board_list">
				<div style="">
					<svg xmlns="http://www.w3.org/2000/svg" width="100px"
						height="100px" fill="currentColor" class="bi bi-chat-square-dots"
						viewBox="0 0 16 16">
  			<path
 			...
 			<path
				...
				<h3>
					<a href="board_list.me"><strong>board</strong> 1:1문의</a>
				</h3>
				<span>고객님께서 작성하신 1:1문의를 관리하는 공간입니다.<br />고객님께서 작성하신 1:1문의를
					한눈에 관리하실 수 있습니다.
				</span>
				<hr>
			</div>
