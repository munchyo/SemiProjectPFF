	...
	<section id="orderInquiry" class="d-flex flex-nowrap" style="min-height: 100vh;">
		<div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
			...
			<ul class="nav nav-pills flex-column mb-auto">
				...
				<li>
					<a href="#" class="nav-link active text-white fs-5">
				...
				<li>
					<a href="#" class="nav-link text-white fs-5">
						<svg class="bi pe-none me-2" width="16" height="32"><use xlink:href="#grid"></use></svg>
						Products
					</a>
				</li>
				<li>
					<a href="#" class="nav-link text-white fs-5">
						<svg class="bi pe-none me-2" width="16" height="32"><use xlink:href="#people-circle"></use></svg>
						Customers
					</a>
				</li>
			</ul>
			...
			if(${ !empty list }) {
				...
				for(let i=1; i<trs.length; i++) {
					if(trs[i].children[0].innerText === trs[i-1].children[0].innerText) {
						...
						trs[i].children[5].style.display = "none";
						...
						if(rowCount > 1) {
							...
							trs[i - rowCount].children[5].rowSpan = rowCount;
				...
				if(rowCount > 1) {
					...
					trs[trs.length - rowCount].children[5].rowSpan = rowCount;
