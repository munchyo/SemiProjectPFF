...
<body>
		...
		<table class="table" id="paymentTable" class="marginTopMedium">
			...
			<tbody>
				<c:forEach items="${ opList }" var="product">
					...
					<tr>
						<td><img src="${pageContext.request.contextPath}/resources/image/coat.jpg" alt="상품 사진" width="80px"></td>
						<td>
	...
	<div id="buttonDiv">
		<button type="button" id="moreShopping" class="buttonDivBtn">쇼핑계속하기</button>
